...
.method static synthetic access$900(Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;)I
    ...
    .prologue
    .line 55
    iget v0, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mLinearFixedEfRecordLength:I
...
.method static synthetic access$902(Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;I)I
    ...
    .prologue
    .line 55
    iput p1, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mLinearFixedEfRecordLength:I
...
.method public updateCBMIR(Ljava/lang/String;)V
    ...
    const-string v12, "SimSMSInterfacemanager updateCBMIR"

    invoke-virtual {v2, v11, v12}, Landroid/content/Context;->enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 919
    :cond_0
    iget-object v12, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mLock:Ljava/lang/Object;
    ...
    :try_start_0
    iput v11, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mTransparentEfSize:I

    .line 922
    iget-object v11, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v11}, Lcom/android/internal/telephony/PhoneBase;->getIccFileHandler()Lcom/android/internal/telephony/IccFileHandler;

    move-result-object v11

    const/16 v13, 0x6f50

    invoke-virtual {v11, v13, v8}, Lcom/android/internal/telephony/IccFileHandler;->loadEFTransparent(ILandroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_0
    :try_start_2
    iget v5, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mTransparentEfSize:I
    ...
    .line 932
    const-string v11, "get CBMIR EF size fail, updateCBMIR fail!"
    ...
    const-string v11, "interrupted while trying to record count"
    ...
    invoke-virtual {v11, v13, v4, v8}, Lcom/android/internal/telephony/IccFileHandler;->updateEFTransparent(I[BLandroid/os/Message;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    const-string v13, "Invalid CBMIR Channel : "
    ...
    .line 976
    .end local v1           #chs:[Ljava/lang/String;
    .end local v6           #endChannel:I
    .end local v9           #startChannel:I
    ...
    const-string v11, "interrupted while trying to empty CBMIR"
...
.method public updateMessageOnIccEfWithType(ZII[B)Z
    ...
    :try_start_0
    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mSuccess:Z
    ...
    :try_start_3
    iput v1, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mLinearFixedEfRecordLength:I
    ...
    :goto_3
    :try_start_5
    iget v1, p0, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->mLinearFixedEfRecordLength:I
    ...
    invoke-virtual {p0, p1, p3, p4, v0}, Lcom/android/internal/telephony/gsm/SimSmsInterfaceManager;->makeSmsRecordDataWithType(ZI[BI)[B
