...
.method public writeStatsListToFile([Lcom/android/internal/os/HtcIfAppUsageStats;)V
    .locals 5
    .parameter "stats"
    ...
    new-array v2, v3, [Lcom/android/internal/os/HtcAppUsageStats;

    .line 95
    .local v2, statsList:[Lcom/android/internal/os/HtcAppUsageStats;
    const/4 v1, 0x0
    ...
    .line 98
    :cond_0
    iget-object v3, p0, Lcom/htc/app/HtcUsageStats;->mHtcAppUsageStatsService:Lcom/android/internal/app/IHtcAppUsageStatsService;

    invoke-interface {v3, v2}, Lcom/android/internal/app/IHtcAppUsageStatsService;->writeStatsListToFile([Lcom/android/internal/os/HtcAppUsageStats;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 102
    .end local v1           #i:I
    .end local v2           #statsList:[Lcom/android/internal/os/HtcAppUsageStats;
    :goto_1
    return-void
    ...
    .line 100
    .local v0, e:Ljava/lang/Exception;
    const-string v3, "HtcUsageStats"

    const-string v4, "writeStatsListToFile error:"
