...
.method public filter(Ljava/util/List;)V
    ...
    .line 33
    :cond_0
    invoke-virtual {v3, v10}, Lcom/htc/painting/penmenu/menu/PenTypeItem;->setEnabled(Z)V
    ...
    .line 43
    const-string v6, "SimplePenFilter"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "filter - filter out pen: "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    invoke-virtual {v3}, Lcom/htc/painting/penmenu/menu/PenTypeItem;->getName()Ljava/lang/String;
    ...
    .line 45
    :cond_1
    invoke-virtual {v3, v10}, Lcom/htc/painting/penmenu/menu/PenTypeItem;->setIgnored(Z)V
    ...
    :cond_2
    invoke-virtual {v3, v9}, Lcom/htc/painting/penmenu/menu/PenTypeItem;->setEnabled(Z)V
    ...
    :cond_3
    invoke-virtual {v3, v9}, Lcom/htc/painting/penmenu/menu/PenTypeItem;->setIgnored(Z)V
