...
.method private static buildQueryParamterForNotes(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    .locals 3
    .parameter "context"
    .parameter "uriString"
    ...
    const-string v2, "buildQueryParamterForNotes"
    ...
    invoke-static {p2}, Lcom/htc/util/calendar/tools/UriTools;->isHTCExchangeEvent(Ljava/lang/String;)Z
    ...
    .line 654
    :cond_0
    invoke-static {p2}, Lcom/htc/util/calendar/tools/UriTools;->isGoogleEvent(Ljava/lang/String;)Z
    ...
    .line 657
    :cond_1
    invoke-static {p0, p2}, Lcom/htc/util/calendar/tools/UriTools;->isHTCFacebookEvent(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static generateTheEventUri(Landroid/content/Context;J)Landroid/net/Uri;
    ...
    .line 472
    .local v9, desUri:Landroid/net/Uri;
    ...
    const-string v12, "iCalGUID"

    aput-object v12, v2, v3

    const/4 v3, 0x3

    const-string v12, "facebook_source_id"
    ...
    .line 487
    .local v5, iUid:Ljava/lang/String;
    ...
    .line 489
    .local v7, facebookId:Ljava/lang/String;
    ...
    invoke-static/range {v2 .. v7}, Lcom/htc/util/calendar/tools/UriTools;->buildQueryParamterForNotes(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v5           #iUid:Ljava/lang/String;
    .end local v6           #syncId:Ljava/lang/String;
    .end local v7           #facebookId:Ljava/lang/String;
    :goto_0
    if-eqz v8, :cond_0
...
.method public static generateUniEventUri(Landroid/content/Context;JJJ)Landroid/net/Uri;
    ...
    .line 568
    .local v11, desUri:Landroid/net/Uri;
    const/4 v10, 0x0
    ...
    const-string v15, "iCalGUID"

    aput-object v15, v4, v5

    const/4 v5, 0x3

    const-string v15, "facebook_source_id"
    ...
    .line 585
    .local v7, iUid:Ljava/lang/String;
    ...
    .line 586
    .local v9, facebookId:Ljava/lang/String;
    ...
    invoke-static/range {v4 .. v9}, Lcom/htc/util/calendar/tools/UriTools;->buildQueryParamterForNotes(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v7           #iUid:Ljava/lang/String;
    .end local v8           #syncId:Ljava/lang/String;
    .end local v9           #facebookId:Ljava/lang/String;
    .end local v13           #isAllDay:I
    :goto_1
    if-eqz v10, :cond_0
    ...
    .restart local v7       #iUid:Ljava/lang/String;
    .restart local v8       #syncId:Ljava/lang/String;
    .restart local v9       #facebookId:Ljava/lang/String;
    .restart local v13       #isAllDay:I
    :cond_1
    :try_start_1
    move-wide/from16 v0, p3
