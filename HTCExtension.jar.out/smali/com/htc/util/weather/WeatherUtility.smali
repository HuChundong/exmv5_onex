...
.method public static getLocationListByCodeUnstable(Landroid/content/ContentResolver;Ljava/lang/String;)Lcom/htc/util/weather/WeatherLocation;
    .locals 10
    .parameter "cr"
    .parameter "code"
    ...
    .line 592
    .local v8, weatherLocation:Lcom/htc/util/weather/WeatherLocation;
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    sget-object v4, Lcom/htc/consts/WeatherConsts$LOCATION_LIST_COLUMN_NAME;->code:Lcom/htc/consts/WeatherConsts$LOCATION_LIST_COLUMN_NAME;
    ...
    .line 599
    .local v0, unstableContentProvider:Landroid/content/ContentProviderClient;
    const/4 v2, 0x0
    ...
    .line 602
    invoke-static {v6}, Lcom/htc/util/weather/WeatherUtility;->CursorToWeatherLocation(Landroid/database/Cursor;)Lcom/htc/util/weather/WeatherLocation;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 605
    const-string v4, "WeatherUtility"
    ...
    :cond_7
    :try_start_3
    const-string v2, "data is incorrect"
