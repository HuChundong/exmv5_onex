...
.method private loadSettingsLocked(I)V
    ...
    const-string v18, "loadSettingsLocked userId="
    ...
    const-string v18, "call migrateFromOld, file not exist:"
    ...
    const-string v18, "loadSettingsLocked before w="
    ...
    const-string v18, "loadSettingsLocked after w="
    ...
    const-string v18, "loadSettingsLocked before baseSize:"
    ...
    const-string v18, "loadSettingsLocked after mWidth:"
...
.method bindWallpaperComponentLocked(Landroid/content/ComponentName;ZZLcom/android/server/WallpaperManagerService$WallpaperData;)Z
    ...
    const-string v16, "bindWallpaperComponentLocked: componentName="
    ...
    const-string v15, "bindWallpaperComponentLocked: still using default"
    ...
    const-string v15, "same wallpaper"
    ...
    const-string v16, "Use default component wallpaper:"
    ...
    const-string v15, "Using image wallpaper"
    ...
    invoke-direct {v14, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-static {v14, v4}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string v16, "detachWallpaperLocked Last "
    ...
    iget-object v0, v0, Lcom/android/server/WallpaperManagerService;->mLastWallpaper:Lcom/android/server/WallpaperManagerService$WallpaperData;
    ...
    const-string v14, "android.intent.action.WALLPAPER_CHANGED"
    ...
    const-string v16, "ACTION_WALLPAPER_CHANGED "
    ...
    .line 882
    :cond_15
    const-string v14, "android.intent.extra.changed_component_name"
    ...
    const-string v16, "Adding window token: "

    invoke-virtual/range {v15 .. v16}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v15

    iget-object v0, v8, Lcom/android/server/WallpaperManagerService$WallpaperConnection;->mToken:Landroid/os/Binder;
...
.method clearWallpaperLocked(ZI)V
    ...
    const-string v8, "clearWallpaperLocked userId="
    ...
    const-string v8, " mCurrentUserId="

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v8, p0, Lcom/android/server/WallpaperManagerService;->mCurrentUserId:I
...
.method public setDimensionHints(II)V
    ...
    .prologue
    .line 573
    const-string v6, "android.permission.SET_WALLPAPER_HINTS"
    ...
    const-string v8, "setDimensionHints input w="
    ...
    const-string v8, "setDimensionHints getSize w="
    ...
    const-string v8, "setDimensionHints adjust w="
    ...
    .line 604
    :try_start_0
    iget v6, v4, Lcom/android/server/WallpaperManagerService$WallpaperData;->width:I

    if-ne p1, v6, :cond_6

    iget v6, v4, Lcom/android/server/WallpaperManagerService$WallpaperData;->height:I

    if-eq p2, v6, :cond_b

    .line 605
    :cond_6
    iput p1, v4, Lcom/android/server/WallpaperManagerService$WallpaperData;->width:I

    .line 606
    iput p2, v4, Lcom/android/server/WallpaperManagerService$WallpaperData;->height:I

    .line 607
    invoke-direct {p0, v4}, Lcom/android/server/WallpaperManagerService;->saveSettingsLocked(Lcom/android/server/WallpaperManagerService$WallpaperData;)V
    ...
    :cond_8
    :try_start_1
    iget-object v6, v4, Lcom/android/server/WallpaperManagerService$WallpaperData;->connection:Lcom/android/server/WallpaperManagerService$WallpaperConnection;
    ...
    iget-object v6, v6, Lcom/android/server/WallpaperManagerService$WallpaperConnection;->mEngine:Landroid/service/wallpaper/IWallpaperEngine;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v9, "setDimensionHints mEngine.setDesiredSize w="
    ...
    const-string v9, " WPConn w="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, v4, Lcom/android/server/WallpaperManagerService$WallpaperData;->connection:Lcom/android/server/WallpaperManagerService$WallpaperConnection;

    #getter for: Lcom/android/server/WallpaperManagerService$WallpaperConnection;->mWPConnWidth:I
    invoke-static {v9}, Lcom/android/server/WallpaperManagerService$WallpaperConnection;->access$300(Lcom/android/server/WallpaperManagerService$WallpaperConnection;)I
    ...
    invoke-static {v9}, Lcom/android/server/WallpaperManagerService$WallpaperConnection;->access$400(Lcom/android/server/WallpaperManagerService$WallpaperConnection;)I
    ...
    invoke-static {v6, p1}, Lcom/android/server/WallpaperManagerService$WallpaperConnection;->access$302(Lcom/android/server/WallpaperManagerService$WallpaperConnection;I)I

    .line 619
    iget-object v6, v4, Lcom/android/server/WallpaperManagerService$WallpaperData;->connection:Lcom/android/server/WallpaperManagerService$WallpaperConnection;

    #setter for: Lcom/android/server/WallpaperManagerService$WallpaperConnection;->mWPConnHeight:I
    invoke-static {v6, p2}, Lcom/android/server/WallpaperManagerService$WallpaperConnection;->access$402(Lcom/android/server/WallpaperManagerService$WallpaperConnection;I)I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    const-string v9, "setDimensionHints notifyCallbacksLocked "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, v4, Lcom/android/server/WallpaperManagerService$WallpaperData;->userId:I
    ...
    .line 624
    :cond_a
    invoke-direct {p0, v4}, Lcom/android/server/WallpaperManagerService;->notifyCallbacksLocked(Lcom/android/server/WallpaperManagerService$WallpaperData;)V
...
.method public setWallpaperComponent(Landroid/content/ComponentName;)V
    ...
    const-string v7, "setWallpaperComponent "
    ...
    const-string v7, " wallpaper.imageWallpaperPending=false userId="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, v3, Lcom/android/server/WallpaperManagerService$WallpaperData;->userId:I
...
.method settingsRestored()V
    ...
    const-string v5, "settingsRestored saveSettingsLocked"
...
.method switchWallpaper(Lcom/android/server/WallpaperManagerService$WallpaperData;)V
    ...
    const-string v6, "switchWallpaper wallpaperComponent "
    ...
    const-string v6, "switchWallpaper nextWallpaperComponent "
...
.method updateWallpaperBitmapLocked(Ljava/lang/String;Lcom/android/server/WallpaperManagerService$WallpaperData;)Landroid/os/ParcelFileDescriptor;
    ...
    const-string v5, "updateWallpaperBitmapLocked "
    ...
    const-string v5, " mImageWallpaperPending="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p2, Lcom/android/server/WallpaperManagerService$WallpaperData;->imageWallpaperPending:Z
