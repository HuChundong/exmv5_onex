...
.method private final addBroadcastToHistoryLocked(Lcom/android/server/am/BroadcastRecord;)V
    ...
    const-string v3, "com.htc.intent.action.NOTIFICATION_UPDATE"
    ...
    const-string v3, "com.htc.intent.action.NOTIFICATION_ADD"
    ...
    const-string v5, "remove intent extra for notification update / add broadcast"
    ...
    .line 980
    .local v19, dispatchClockTime:J
    new-instance v2, Lcom/android/server/am/BroadcastRecord;

    move-object/from16 v0, p1

    iget-object v3, v0, Lcom/android/server/am/BroadcastRecord;->queue:Lcom/android/server/am/BroadcastQueue;
    ...
    iget v12, v0, Lcom/android/server/am/BroadcastRecord;->resultCode:I
    ...
    invoke-direct/range {v2 .. v17}, Lcom/android/server/am/BroadcastRecord;-><init>(Lcom/android/server/am/BroadcastQueue;Landroid/content/Intent;Lcom/android/server/am/ProcessRecord;Ljava/lang/String;IILjava/lang/String;Ljava/util/List;Landroid/content/IIntentReceiver;ILjava/lang/String;Landroid/os/Bundle;ZZZ)V
    :try_end_0
    ...
    iput-wide v0, v2, Lcom/android/server/am/BroadcastRecord;->dispatchClockTime:J
    :try_end_1
    ...
    .end local v19           #dispatchClockTime:J
    .end local v21           #dispatchTime:J
    .restart local p1
    :cond_2
    :goto_1
    ...
    iput-wide v5, v0, Lcom/android/server/am/BroadcastRecord;->finishTime:J
    ...
    const-string v6, "remove intent extra fail"
    ...
    .restart local v19       #dispatchClockTime:J
    .restart local v21       #dispatchTime:J
    :catch_1
    move-exception v23
...
.method private final deliverToRegisteredReceiverLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/BroadcastFilter;Z)V
    ...
    const-string v2, "called performReceive() for "
...
.method private final processCurBroadcastLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v2, "called scheduleReceiver() for component "
...
.method final broadcastTimeoutLocked(Z)V
    ...
    .line 906
    :goto_2
    iput-wide v14, v4, Lcom/android/server/am/BroadcastRecord;->receiverTime:J
