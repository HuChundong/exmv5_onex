...
.field mGestureInputFilter:Lcom/android/server/input/InputFilter;

.field mGestureInputFilterHost:Lcom/android/server/input/InputManagerService$InputFilterHost;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/input/InputManagerService$Callbacks;)V
    ...
    iput-object v0, p0, Lcom/android/server/input/InputManagerService;->mGestureInputFilterLock:Ljava/lang/Object;
...
.method private sendKeyCode(I)V
    ...
    invoke-interface {v0, p1}, Lcom/android/server/input/InputManagerService$Callbacks;->sendKeyCode(I)V
...
.method private sendMotionXY(FF)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/server/input/InputManagerService$Callbacks;->sendMotionXY(FF)V
...
.method private sendTrackballXY(FF)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/server/input/InputManagerService$Callbacks;->sendTrackballXY(FF)V
...
.method final filterGestureInputEvent(Landroid/view/InputEvent;I)Z
    ...
    .prologue
    .line 1347
    iget-object v1, p0, Lcom/android/server/input/InputManagerService;->mGestureInputFilterLock:Ljava/lang/Object;

    monitor-enter v1

    .line 1348
    :try_start_0
    iget-object v0, p0, Lcom/android/server/input/InputManagerService;->mGestureInputFilter:Lcom/android/server/input/InputFilter;
...
.method public setFocusedApplication(Lcom/android/server/input/InputApplicationHandle;)V
    ...
    iget-object v5, p1, Lcom/android/server/input/InputApplicationHandle;->name:Ljava/lang/String;
    ...
    invoke-virtual {v5, v6}, Lcom/htc/service/HtcGestureManager;->checkHtcGestureFilterOutList(Ljava/lang/String;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 1068
    .end local v0           #appName:Ljava/lang/String;
    .end local v2           #packageEnd:I
    .end local v3           #packageStart:I
    .end local v4           #recordStart:I
    :goto_0
    ...
    const-string v7, "setFocusedApplication Exception: "
...
.method public setGestureInputFilter(Lcom/android/server/input/InputFilter;)V
    .locals 4
    .parameter "filter"

    .prologue
    .line 481
    iget-object v2, p0, Lcom/android/server/input/InputManagerService;->mGestureInputFilterLock:Ljava/lang/Object;
    ...
    iput-object v1, p0, Lcom/android/server/input/InputManagerService;->mGestureInputFilter:Lcom/android/server/input/InputFilter;

    .line 489
    iget-object v1, p0, Lcom/android/server/input/InputManagerService;->mGestureInputFilterHost:Lcom/android/server/input/InputManagerService$InputFilterHost;
    ...
    iput-object v1, p0, Lcom/android/server/input/InputManagerService;->mGestureInputFilterHost:Lcom/android/server/input/InputManagerService$InputFilterHost;
    ...
    .line 495
    iput-object p1, p0, Lcom/android/server/input/InputManagerService;->mGestureInputFilter:Lcom/android/server/input/InputFilter;
    ...
    :goto_1
    invoke-static {v3, v1}, Lcom/android/server/input/InputManagerService;->nativeSetGestureInputFilterEnabled(IZ)V
