...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 161
    .local v164, result:Landroid/app/IActivityManager$WaitResult;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v14           #profileFd:Landroid/os/ParcelFileDescriptor;
    .end local v15           #options:Landroid/os/Bundle;
    .end local v164           #result:Landroid/app/IActivityManager$WaitResult;
    :cond_2
    const/4 v14, 0x0
    ...
    .line 374
    .end local v170           #stopProfiling:Z
    :cond_1b
    const/16 v170, 0x0
    ...
    .line 394
    .local v135, map:Landroid/os/Bundle;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 396
    .local v178, thumbnail:Landroid/graphics/Bitmap;
    :goto_16
    ...
    .end local v178           #thumbnail:Landroid/graphics/Bitmap;
    :cond_1c
    const/16 v178, 0x0
    ...
    .line 403
    .end local v49           #token:Landroid/os/IBinder;
    .end local v135           #map:Landroid/os/Bundle;
    :pswitch_13
    const-string v5, "android.app.IActivityManager"
    ...
    .line 422
    .local v163, res:Ljava/lang/String;
    :goto_17
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 421
    .end local v163           #res:Ljava/lang/String;
    :cond_1d
    const/16 v163, 0x0
    ...
    .line 445
    .local v129, list:Ljava/util/List;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    check-cast v123, Landroid/app/ActivityManager$RunningTaskInfo;

    .line 452
    .local v123, info:Landroid/app/ActivityManager$RunningTaskInfo;
    const/4 v5, 0x0
    ...
    .end local v94           #N:I
    .end local v118           #i:I
    .end local v123           #info:Landroid/app/ActivityManager$RunningTaskInfo;
    .end local v129           #list:Ljava/util/List;
    ...
    .line 446
    .restart local v129       #list:Ljava/util/List;
    ...
    .line 463
    .local v131, list:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RecentTaskInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 469
    .end local v59           #fl:I
    .end local v131           #list:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RecentTaskInfo;>;"
    .end local v137           #maxNum:I
    :pswitch_19
    const-string v5, "android.app.IActivityManager"
    ...
    check-cast v123, Landroid/app/ActivityManager$RunningServiceInfo;

    .line 494
    .local v123, info:Landroid/app/ActivityManager$RunningServiceInfo;
    const/4 v5, 0x0
    ...
    .end local v94           #N:I
    .end local v118           #i:I
    .end local v123           #info:Landroid/app/ActivityManager$RunningServiceInfo;
    :cond_22
    const/16 v94, -0x1
    ...
    .line 502
    .local v130, list:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$ProcessErrorStateInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 508
    .end local v130           #list:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$ProcessErrorStateInfo;>;"
    :pswitch_1c
    const-string v5, "android.app.IActivityManager"
    ...
    .line 510
    .local v132, list:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningAppProcessInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 516
    .end local v132           #list:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningAppProcessInfo;>;"
    :pswitch_1d
    const-string v5, "android.app.IActivityManager"
    ...
    .line 518
    .local v133, list:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ApplicationInfo;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 524
    .end local v133           #list:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ApplicationInfo;>;"
    :pswitch_1e
    const-string v5, "android.app.IActivityManager"
    ...
    .line 576
    .restart local v178       #thumbnail:Landroid/graphics/Bitmap;
    :goto_23
    sget-object v5, Landroid/text/TextUtils;->CHAR_SEQUENCE_CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 587
    .local v142, name:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v101           #b:Landroid/os/IBinder;
    .end local v111           #cph:Landroid/app/IActivityManager$ContentProviderHolder;
    .end local v142           #name:Ljava/lang/String;
    .end local v168           #stable:Z
    :pswitch_25
    const-string v5, "android.app.IActivityManager"
    ...
    .line 602
    .restart local v142       #name:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readStrongBinder()Landroid/os/IBinder;
    ...
    .end local v101           #b:Landroid/os/IBinder;
    .end local v163           #res:Z
    .end local v168           #stable:I
    .end local v179           #unstable:I
    :pswitch_28
    const-string v5, "android.app.IActivityManager"
    ...
    .line 666
    .local v148, pi:Landroid/app/PendingIntent;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v148           #pi:Landroid/app/PendingIntent;
    :pswitch_2c
    const-string v5, "android.app.IActivityManager"
    ...
    .line 800
    .local v165, results:Landroid/os/Bundle;
    move-object/from16 v0, p0
    ...
    .end local v40           #resultCode:I
    .end local v101           #b:Landroid/os/IBinder;
    .end local v165           #results:Landroid/os/Bundle;
    :pswitch_37
    const-string v5, "android.app.IActivityManager"
    ...
    .line 825
    .local v162, requestedOrientation:I
    move-object/from16 v0, p0
    ...
    .line 831
    .end local v49           #token:Landroid/os/IBinder;
    .end local v162           #requestedOrientation:I
    :pswitch_3a
    const-string v5, "android.app.IActivityManager"
    ...
    .line 878
    .local v163, res:Landroid/content/IIntentSender;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    .line 879
    if-eqz v163, :cond_37

    invoke-interface/range {v163 .. v163}, Landroid/content/IIntentSender;->asBinder()Landroid/os/IBinder;
    ...
    .end local v163           #res:Landroid/content/IIntentSender;
    :cond_35
    const/16 v72, 0x0
    ...
    .line 879
    .restart local v15       #options:Landroid/os/Bundle;
    .restart local v163       #res:Landroid/content/IIntentSender;
    :cond_37
    const/4 v5, 0x0
    ...
    const-string v17, "[GhostScreen] Set intent htc flag : "
    ...
    const-string v17, "[GhostScreen] Add intent htc flag : "
    ...
    .line 1010
    .local v144, observer:Landroid/content/pm/IPackageDataObserver;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v18           #packageName:Ljava/lang/String;
    .end local v46           #userId:I
    .end local v144           #observer:Landroid/content/pm/IPackageDataObserver;
    .end local v163           #res:Z
    :pswitch_4a
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1052
    new-instance v139, Landroid/app/ActivityManager$MemoryInfo;

    invoke-direct/range {v139 .. v139}, Landroid/app/ActivityManager$MemoryInfo;-><init>()V

    .line 1053
    .local v139, mi:Landroid/app/ActivityManager$MemoryInfo;
    move-object/from16 v0, p0
    ...
    .line 1060
    .end local v139           #mi:Landroid/app/ActivityManager$MemoryInfo;
    :pswitch_4e
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1070
    .local v147, pfd:Landroid/os/ParcelFileDescriptor;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1081
    .end local v86           #uri:Landroid/net/Uri;
    .end local v147           #pfd:Landroid/os/ParcelFileDescriptor;
    :pswitch_50
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1104
    .local v152, pn:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1104
    .end local v146           #per:Z
    .end local v185           #wfd:Z
    :cond_3d
    const/16 v185, 0x0
    ...
    .line 1112
    .end local v152           #pn:Ljava/lang/String;
    .end local v185           #wfd:Z
    :pswitch_54
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1123
    .local v184, watcher:Landroid/app/IActivityController;
    move-object/from16 v0, p0
    ...
    .line 1128
    .end local v184           #watcher:Landroid/app/IActivityController;
    :pswitch_56
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1138
    .local v125, is:Landroid/content/IIntentSender;
    move-object/from16 v0, p0
    ...
    .line 1144
    .end local v125           #is:Landroid/content/IIntentSender;
    :pswitch_58
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1166
    .local v151, pkg:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 1169
    .local v122, indata:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v122           #indata:Ljava/lang/String;
    .end local v151           #pkg:Ljava/lang/String;
    :pswitch_5b
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1187
    .local v174, tag:Ljava/lang/String;
    new-instance v107, Landroid/app/ApplicationErrorReport$CrashInfo;
    ...
    .end local v107           #ci:Landroid/app/ApplicationErrorReport$CrashInfo;
    .end local v163           #res:Z
    .end local v174           #tag:Ljava/lang/String;
    :pswitch_5d
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1198
    .local v182, violationMask:I
    new-instance v123, Landroid/os/StrictMode$ViolationInfo;
    ...
    .line 1199
    .local v123, info:Landroid/os/StrictMode$ViolationInfo;
    move-object/from16 v0, p0
    ...
    .line 1205
    .end local v6           #app:Landroid/os/IBinder;
    .end local v123           #info:Landroid/os/StrictMode$ViolationInfo;
    .end local v182           #violationMask:I
    :pswitch_5e
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1237
    new-instance v123, Landroid/app/ActivityManager$RunningAppProcessInfo;

    invoke-direct/range {v123 .. v123}, Landroid/app/ActivityManager$RunningAppProcessInfo;-><init>()V

    .line 1239
    .local v123, info:Landroid/app/ActivityManager$RunningAppProcessInfo;
    move-object/from16 v0, p0
    ...
    .line 1246
    .end local v123           #info:Landroid/app/ActivityManager$RunningAppProcessInfo;
    :pswitch_63
    const-string v5, "android.app.IActivityManager"
    ...
    check-cast v123, Landroid/content/pm/ApplicationInfo;

    .line 1302
    .local v123, info:Landroid/content/pm/ApplicationInfo;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v123           #info:Landroid/content/pm/ApplicationInfo;
    .end local v173           #success:Z
    :pswitch_6a
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1321
    .restart local v123       #info:Landroid/content/pm/ApplicationInfo;
    move-object/from16 v0, p0
    ...
    .line 1348
    .restart local v151       #pkg:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1366
    .local v163, res:[Landroid/os/Debug$MemoryInfo;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1372
    .end local v150           #pids:[I
    .end local v163           #res:[Landroid/os/Debug$MemoryInfo;
    :pswitch_70
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1438
    .local v138, message:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v18           #packageName:Ljava/lang/String;
    .end local v81           #uid:I
    .end local v124           #initialPid:I
    .end local v138           #message:Ljava/lang/String;
    :pswitch_78
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1595
    .local v180, userInfo:Landroid/content/pm/UserInfo;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1602
    .end local v180           #userInfo:Landroid/content/pm/UserInfo;
    :pswitch_86
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1613
    .end local v164           #result:Z
    .end local v172           #subTaskIndex:I
    .end local v177           #taskId:I
    :pswitch_87
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1626
    .local v144, observer:Landroid/app/IProcessObserver;
    move-object/from16 v0, p0
    ...
    .line 1631
    .end local v144           #observer:Landroid/app/IProcessObserver;
    :pswitch_89
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1634
    .restart local v144       #observer:Landroid/app/IProcessObserver;
    move-object/from16 v0, p0
    ...
    check-cast v141, Ljava/lang/CharSequence;

    .line 1698
    .local v141, msg:Ljava/lang/CharSequence;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1705
    .end local v141           #msg:Ljava/lang/CharSequence;
    :pswitch_91
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1725
    .local v175, target:Landroid/content/Intent;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v49           #token:Landroid/os/IBinder;
    .end local v163           #res:Z
    .end local v175           #target:Landroid/content/Intent;
    :pswitch_94
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1749
    .local v123, info:Landroid/app/HtcDeviceInfo;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1755
    .end local v123           #info:Landroid/app/HtcDeviceInfo;
    :pswitch_96
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1822
    .local v153, prev:Ljava/lang/String;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1830
    .end local v153           #prev:Ljava/lang/String;
    :pswitch_9d
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1832
    .local v171, strActivityName:Ljava/lang/String;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1840
    .end local v171           #strActivityName:Ljava/lang/String;
    :pswitch_9e
    const-string v5, "android.app.IActivityManager"
