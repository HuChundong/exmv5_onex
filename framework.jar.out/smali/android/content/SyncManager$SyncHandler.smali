...
.method private maybeStartNextSyncLocked()J
    ...
    #getter for: Landroid/content/SyncManager;->mDataConnectionIsConnected:Z
    invoke-static/range {v34 .. v34}, Landroid/content/SyncManager;->access$400(Landroid/content/SyncManager;)Z
    ...
    invoke-static/range {v34 .. v34}, Landroid/content/SyncManager;->access$2200(Landroid/content/SyncManager;)[Landroid/accounts/AccountAndUser;
    ...
    invoke-static/range {v34 .. v34}, Landroid/content/SyncManager;->access$300(Landroid/content/SyncManager;)Landroid/net/ConnectivityManager;

    move-result-object v34

    invoke-virtual/range {v34 .. v34}, Landroid/net/ConnectivityManager;->getBackgroundDataSetting()Z
    ...
    .line 1930
    .local v19, nextReadyToRunTime:J
    new-instance v28, Ljava/util/ArrayList;

    invoke-direct/range {v28 .. v28}, Ljava/util/ArrayList;-><init>()V

    .line 1931
    .local v28, operations:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/SyncOperation;>;"
    move-object/from16 v0, p0
    ...
    .line 1938
    .local v27, operationIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/content/SyncOperation;>;"
    :cond_8
    :goto_1
    ...
    check-cast v26, Landroid/content/SyncOperation;

    .line 1942
    .local v26, op:Landroid/content/SyncOperation;
    move-object/from16 v0, p0
    ...
    #getter for: Landroid/content/SyncManager;->mSyncStorageEngine:Landroid/content/SyncStorageEngine;
    invoke-static/range {v34 .. v34}, Landroid/content/SyncManager;->access$600(Landroid/content/SyncManager;)Landroid/content/SyncStorageEngine;
    ...
    .line 2022
    .end local v26           #op:Landroid/content/SyncOperation;
    .end local v27           #operationIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/content/SyncOperation;>;"
    :catchall_0
    move-exception v34
    ...
    .line 1949
    .restart local v26       #op:Landroid/content/SyncOperation;
    .restart local v27       #operationIterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/content/SyncOperation;>;"
    :cond_9
    :try_start_1
    move-object/from16 v0, p0
    ...
    #getter for: Landroid/content/SyncManager;->mStorageIsLow:Z
    invoke-static/range {v34 .. v34}, Landroid/content/SyncManager;->access$000(Landroid/content/SyncManager;)Z
    ...
    const-string v36, "com.htc.sync.provider.weather"
    ...
    const-string v36, "com.htc.stock"
    ...
    const-string v37, "drop sync, mStorageIsLow = "
    ...
    #getter for: Landroid/content/SyncManager;->mStorageIsLow:Z
    invoke-static/range {v37 .. v37}, Landroid/content/SyncManager;->access$000(Landroid/content/SyncManager;)Z
    ...
    const-string/jumbo v37, "mStorageIsLow is true, "
    ...
    const-string v37, " check is lower than 50MB or not"
    ...
    #getter for: Landroid/content/SyncManager;->mDataStats:Landroid/os/StatFs;
    invoke-static/range {v34 .. v34}, Landroid/content/SyncManager;->access$2600(Landroid/content/SyncManager;)Landroid/os/StatFs;
    ...
    .line 1968
    .local v12, freeMem:J
    const-wide/32 v36, 0x3200000

    cmp-long v34, v12, v36
    ...
    const-string v37, "drop sync, storage is lower than 50mb, freeMem = "
    ...
    const-string v37, ", account type is null"
    ...
    invoke-static/range {v36 .. v37}, Landroid/content/SyncAdapterType;->newKey(Ljava/lang/String;Ljava/lang/String;)Landroid/content/SyncAdapterType;
    ...
    const-string v36, "ignore_settings"
    ...
    .line 2040
    .local v17, longRunning:Landroid/content/SyncManager$ActiveSyncContext;
    const/16 v32, 0x0
    ...
    .line 2043
    .local v25, oldestNonExpeditedRegular:Landroid/content/SyncManager$ActiveSyncContext;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v34 .. v34}, Landroid/content/SyncOperation;->isInitialization()Z
    ...
    invoke-virtual/range {v34 .. v35}, Landroid/content/SyncManager;->scheduleSyncOperation(Landroid/content/SyncOperation;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v13, "sync msg = "
