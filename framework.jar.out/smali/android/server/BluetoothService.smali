...
.field private static BLUEZ_ADDR_LOCATION:Ljava/lang/String; = null
...
.field private mEnableNativeThread:Ljava/lang/Thread;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 159
    const-string v0, "/data/misc/bluetoothd"

    sput-object v0, Landroid/server/BluetoothService;->BLUEZ_ADDR_LOCATION:Ljava/lang/String;
...
.method static synthetic access$100(Landroid/server/BluetoothService;)Ljava/util/HashMap;
    .locals 1
    .parameter "x0"

    .prologue
    .line 96
    iget-object v0, p0, Landroid/server/BluetoothService;->mUuidCallbackTracker:Ljava/util/HashMap;
...
.method static synthetic access$1100(Landroid/server/BluetoothService;)Ljava/util/ArrayList;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$700(Landroid/server/BluetoothService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method private native forceSlaveOnACLNative(Ljava/lang/String;)Z
.end method
...
.method private getInternalBdAddress()Ljava/lang/String;
    .locals 6
    ...
    sget-object v2, Landroid/server/BluetoothService;->BLUEZ_ADDR_LOCATION:Ljava/lang/String;
...
.method private isFolderEmpty()Z
    .locals 3
    ...
    const-string v1, "/data/misc/bluetoothd"
    ...
    const-string v2, "bluetoothd folder is not empty"
...
.method declared-synchronized cleanupAfterFinishDisable()V
    ...
    const-string/jumbo v5, "unbind the Headset service"
    ...
    invoke-virtual {v4}, Landroid/server/BluetoothBondState;->closeBondState()V
    :try_end_2
...
.method public connectSink(Ljava/lang/String;)Z
    ...
    .local v1, i:I
    :goto_1
    iget-object v6, p0, Landroid/server/BluetoothService;->delayOutConDevices:[Ljava/lang/String;
    ...
    const-string v7, "Delay outgoing a2dp connection is set to true"
    ...
    .line 2851
    :cond_2
    iget-object v6, p0, Landroid/server/BluetoothService;->mDeviceProfileState:Ljava/util/HashMap;
    ...
    const-string v6, "Delaying outgoing a2dp connection"
    ...
    invoke-virtual {v4, v2, v6, v7}, Landroid/bluetooth/BluetoothProfileState;->sendMessageDelayed(Landroid/os/Message;J)V
...
.method public declared-synchronized getAddress()Ljava/lang/String;
    ...
    invoke-direct {p0}, Landroid/server/BluetoothService;->getInternalBdAddress()Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized initAfterRegistration()V
    ...
    .line 384
    invoke-direct {p0}, Landroid/server/BluetoothService;->isFolderEmpty()Z
    ...
    const-string v1, "Bd address is null"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 387
    iget-object v0, p0, Landroid/server/BluetoothService;->mEnableNativeThread:Ljava/lang/Thread;
    ...
    const-string v1, "DelayDisableThread"

    invoke-direct {v0, p0, v1}, Landroid/server/BluetoothService$1;-><init>(Landroid/server/BluetoothService;Ljava/lang/String;)V

    iput-object v0, p0, Landroid/server/BluetoothService;->mEnableNativeThread:Ljava/lang/Thread;
...
.method public declared-synchronized sendConnectionStateChange(Landroid/bluetooth/BluetoothDevice;III)V
    ...
    invoke-virtual {p0, v2}, Landroid/server/BluetoothService;->getRemoteName(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    .line 3104
    .local v1, remoteDeviceName:Ljava/lang/String;
    const-string v2, "BluetoothService"
    ...
    const-string v4, "Remote device name: "
    ...
    const-string v2, "9xxPlantronics"
    ...
    const-string v3, "forceSlaveOnACLNative() called"
    ...
    invoke-direct {p0, v2}, Landroid/server/BluetoothService;->forceSlaveOnACLNative(Ljava/lang/String;)Z

    .line 3114
    .end local v1           #remoteDeviceName:Ljava/lang/String;
    :cond_2
    ...
    const-string v4, "Error in sendConnectionStateChange: prevState "
    ...
    .line 3138
    const-string v2, "android.bluetooth.adapter.extra.PREVIOUS_CONNECTION_STATE"
