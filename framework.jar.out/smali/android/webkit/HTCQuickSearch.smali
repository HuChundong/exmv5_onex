...
.method public constructor <init>(Landroid/webkit/WebViewClassic;)V
    ...
    .line 41
    iput-object p1, p0, Landroid/webkit/HTCQuickSearch;->mWebView:Landroid/webkit/WebViewClassic;
...
.method static synthetic access$000(Landroid/webkit/HTCQuickSearch;)Landroid/webkit/WebViewClassic;
    .locals 1
    .parameter "x0"

    .prologue
    .line 22
    iget-object v0, p0, Landroid/webkit/HTCQuickSearch;->mWebView:Landroid/webkit/WebViewClassic;
...
.method public enterQuickSearchShareMode(Ljava/lang/String;)V
    ...
    .line 79
    iget-object v1, p0, Landroid/webkit/HTCQuickSearch;->mWebView:Landroid/webkit/WebViewClassic;

    invoke-virtual {v1, p1}, Landroid/webkit/WebViewClassic;->findAll(Ljava/lang/String;)I
...
.method public leaveQuickSearchShareMode()V
    ...
    .line 95
    invoke-virtual {p0, v1}, Landroid/webkit/HTCQuickSearch;->setTouchedBeforeFinish(Z)V
    ...
    iput-boolean v0, p0, Landroid/webkit/HTCQuickSearch;->mQuickSearchShareMode:Z
    ...
    invoke-virtual {v0, v1}, Landroid/webkit/WebSettingsClassic;->setUseWideViewPort(Z)V

    .line 102
    iget-object v0, p0, Landroid/webkit/HTCQuickSearch;->mWebView:Landroid/webkit/WebViewClassic;

    invoke-virtual {v0}, Landroid/webkit/WebViewClassic;->clearMatches()V
...
.method public shareContent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 49
    iget-object v3, p0, Landroid/webkit/HTCQuickSearch;->mWebView:Landroid/webkit/WebViewClassic;

    invoke-virtual {v3}, Landroid/webkit/WebViewClassic;->getContext()Landroid/content/Context;

    move-result-object v3

    iget-object v4, p0, Landroid/webkit/HTCQuickSearch;->mWebView:Landroid/webkit/WebViewClassic;
...
.method protected startTranslation(Ljava/lang/String;Landroid/os/Handler;)V
    ...
    invoke-direct {v0, p0}, Landroid/webkit/HTCQuickSearch$1;-><init>(Landroid/webkit/HTCQuickSearch;)V
